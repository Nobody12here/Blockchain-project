...
export const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'All you need to do is share the Campaign with your friends, family and others. In no time, support will start pouring in.',
    },
    {
      icon: Wallet,
      title: 'Request and Withdraw Funds',
      description: 'The funds raised can be withdrawn directly to the recipient when 50% of the contributors approve of the Withdrawal Request.',
    },
  ];
